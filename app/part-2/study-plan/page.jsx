            ...
            <div className='grid  sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className='bg-[#FFFDE8] px-2 sm:px-6 rounded-xl border border-[#E4BFAF] py-9'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>Back testing VaR   <span className='text-[#BE4E1E]'>[MR-4]</span></li>
                ...
                <div className='bg-[#FFFDE8] px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        <li className='text-[11px] sm:text-[18px]'>Empirical Approaches to Risk Metrics & Hedging <span className='text-[#BE4E1E]'>[MR-11]</span></li>
        ...
        content: (
            <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <div className='bg-[#FFF9E6] px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        <li className='text-[11px] sm:text-[18px]'>The Credit Decision <span className='text-[#BE4E1E]'>[CR-1]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>The Credit Analyst  <span className='text-[#BE4E1E]'>[CR-2]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Classifications and Key Concepts of Credit Risk <span className='text-[#BE4E1E]'>[CR-3]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Rating Assignment Methodologies  <span className='text-[#BE4E1E]'>[CR-4]</span></li>
                ...
                <div className='bg-[#FFF9E6] px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        <li className='text-[11px] sm:text-[18px]'>Credit Risk and Credit Derivatives  <span className='text-[#BE4E1E]'>[CR-5]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Spread Risk and Default Intensity Models <span className='text-[#BE4E1E]'>[CR-6] </span></li>
                        <li className='text-[11px] sm:text-[18px]'>Portfolio Credit Risk <span className='text-[#BE4E1E]'>[CR-7]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Structured Credit Risk  <span className='text-[#BE4E1E]'>[CR-8]</span></li>
                ...
                <div className='bg-[#FFF9E6] px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        <li className='text-[11px] sm:text-[18px]'>Counterparty Risk and Beyond  <span className='text-[#BE4E1E]'>[CR-9]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Netting, Close-out and Related Aspects   <span className='text-[#BE4E1E]'>[CR-11]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Margin (Collateral) and Settlement <span className='text-[#BE4E1E]'>[CR-11]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Future Value and Exposure <span className='text-[#BE4E1E]'>[CR-12]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>CVA  <span className='text-[#BE4E1E]'>[CR-13]</span></li>
                    </ul>
                </div>
            </div>
        ),
        ...
        content: (
            <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className='bg-[#FFF3E5] px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        <li className='text-[11px] sm:text-[18px]'>The Evolution of Stress Testing Counterparty Exposures <span className='text-[#BE4E1E]'>[CR-14]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>An Introduction to Securitization  <span className='text-[#BE4E1E]'>[CR-17]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Understanding the Securitization of Subprime Mortgage Credit   <span className='text-[#BE4E1E]'>[CR-18]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Performing Due Diligence on Specific Managers & Funds  <span className='text-[#BE4E1E]'>[IM-11]</span></li>
                ...
                <div className='bg-[#FFF3E5]  px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>Intraday Liquidity Risk Management  <span className='text-[#BE4E1E]'>[LR-6] </span></li>
                ...
                <div className='bg-[#FFF3E5]  px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>Managing Non-deposit Liabilities  <span className='text-[#BE4E1E]'>[LR-13]</span></li>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>Risk Management for Changing Interest Rates: Asset-Liability Management & Duration Techniques  <span className='text-[#BE4E1E]'>[LR-18]</span></li>
                    </ul>
                </div>
            </div>
        ),
            ...
            <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                <div className='bg-[#FFEFE6]  px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>The US Dollar Shortage in Global Banking & the International Policy Response <span className='text-[#BE4E1E]'>[LR-16]</span></li>
                ...
                <div className='bg-[#FFEFE6]  px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>Case Study: Cyber Threats & Information Security Risks <span className='text-[#BE4E1E]'>[OR-9]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Sound Management of Risks Related to Money Laundering & Financing of Terrorism <span className='text-[#BE4E1E]'>[OR-10]</span></li>
                ...
                <div className='bg-[#FFEFE6]  px-2 sm:px-6 py-9 rounded-xl border border-[#E4BFAF]'>
                    ...
                    <ul className='list-disc list-outside mx-5'>
                        ...
                        <li className='text-[11px] sm:text-[18px]'>Capital Planning at Large Bank Holding Companies: Supervisory Expectations and Range of Current Practice  <span className='text-[#BE4E1E]'>[OR-20] </span></li>
                        <li className='text-[11px] sm:text-[18px]'>Stress Testing Banks <span className='text-[#BE4E1E]'>[OR-17]</span></li>
                        <li className='text-[11px] sm:text-[18px]'>Messages from the Academic Literature on Risk Measurement for the Trading Book <span className='text-[#BE4E1E]'>[MR-6]</span></li>
                    </ul>
                </div>
            </div>
        ),
